...
def main():
    ...
    setting, graph = good_fidelity(4, 4, 300, "MNIST", True)
    setting, graph = good_fidelity(4, 4, 300, "MNIST", False)
    setting, graph = good_fidelity(4, 4, 300, "CIFAR", True)
    setting, graph = good_fidelity(4, 4, 300, "CIFAR", False)

...
def main():
    ...
    setting, graph = good_fidelity(4, 4, 30, "MNIST", True)
    setting, graph = good_fidelity(4, 4, 30, "MNIST", False)
    setting, graph = good_fidelity(4, 4, 30, "CIFAR", True)
    setting, graph = good_fidelity(4, 4, 30, "CIFAR", False)
